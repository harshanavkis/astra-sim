...
- Smoke (`smoke.csv`, 4-NPU 1 MB all-to-all): b3_ideal_rdma 10195 < loom 14565 < b1_gpu_rdma 20105 < b2_cpu_proxy 36744. Loom vs B1 **+27.56%**.
...
- Matrix (`matrix.csv`, 24 Loom-vs-B1 cells): +3.7...+40.5% @1 MB, +0.3...+23.5% @16 MB, +0.0...+4.4% @64 MB.
  ...
  vs B3: +0.0...+101.2% off B3 across all 24 cells.
