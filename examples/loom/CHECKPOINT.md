...
- Smoke (`smoke.csv`, 4-NPU 1 MB all-to-all): b3_ideal_rdma 10195 < loom 14645 < b1_gpu_rdma 20105 < b2_cpu_proxy 36744. Loom vs B1 **+27.16%**.
...
| in_rack | 4 KB | -7.6% | +47.7% |
| in_rack | 16 KB | -6.5% | +44.1% |
| in_rack | 64 KB | -4.1% | +33.8% |
| in_rack | 256 KB | -1.7% | +17.5% |
| in_rack | 1 MB | -0.5% | +6.0% |
| in_rack | 4 MB | -0.1% | +1.6% |
...
- Matrix (`matrix.csv`, 24 Loom-vs-B1 cells): +3.5...+39.9% @1 MB, +0.2...+23.0% @16 MB, -0.2...+4.3% @64 MB.
  2 negative cells (2x all_reduce); worst **-0.25%** (rack8x8 all_reduce 64 MB).
  vs B2: Loom wins all 24 cells (+0.3...+72.9%).
  vs B3: +0.1...+103.2% off B3 across all 24 cells.
- Apps (`apps.csv`): gpt3_dense 32 ranks **+5.36%**; gpt3_dense 64 ranks **+4.98%**; mixtral_moe 16 ranks **+7.55%**; mixtral_moe 64 ranks **+15.17%** vs B1.
...
| gpt3_dense | 64 | 88.3% | +3.8% | +14.1% | **+4.98%** |
| mixtral_moe | 16 | 62.8% | +4.1% | +13.4% | **+7.55%** |
| mixtral_moe | 64 | 82.3% | +15.6% | +13.2% | **+15.17%** |


- Matrix F2 (direct algorithms) (`matrix_direct.csv`, 24 Loom-vs-B1 cells): +3.5...+39.8% @1 MB, +0.2...+23.0% @16 MB, -0.2...+4.3% @64 MB.
  2 negative cells (2x all_reduce); worst **-0.25%** (rack8x8 all_reduce 64 MB).
  vs B2: Loom wins all 24 cells (+0.3...+72.8%).
  vs B3: +0.2...+103.5% off B3 across all 24 cells.
- Apps F2 (direct algorithms) (`apps_direct.csv`): gpt3_dense 32 ranks **+5.36%**; gpt3_dense 64 ranks **+4.98%**; mixtral_moe 16 ranks **+7.55%**; mixtral_moe 64 ranks **+15.17%** vs B1.
...
**AND 40 ns IS ITSELF AN UPPER BOUND - a stock GPU switch already does
this work.** NVIDIA's NVSwitch technical overview documents "final
