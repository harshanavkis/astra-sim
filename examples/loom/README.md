...
├── results/                   CSVs + PDFs + FIGURES.md (gitignored;
│                              root-owned by Docker). FIGURES.md is
│                              GENERATED by plot_results.py and overwritten
│                              on every replot: methodology, metric and
│                              reading for each figure
